...
```javascript
bternary5d = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-broadcasted-ternary5d@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/array-base-broadcasted-ternary5d/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/array-base-broadcasted-ternary5d/actions/workflows/test.yml?query=branch:v0.1.1
